...
let $containerTerms = document.querySelector(
  ".Footer .Section-div--lightbox"
);
let $divOurGartenInfo = document.querySelector(
  "#ourGarten .modalOurGartenInfo"
);
let $divTerms = document.querySelector(
  ".Footer .modalTerms"
);
...
function modalTerms() {
  ...
  <div class="bigText scrollBar">
  <p >Quiénes somos <br>
  La dirección de nuestra web es: https://www.Jardinbarquitodepapel.com
  ...
  Cuando los visitantes diligencian el formulario de contáctenos los datos son enviados al correo RedesBarquito@gmail.com
  ...
  Jardinbarquitodepapel no comparte los datos recolectados en la página www.Jardinbarquitodepapel.com con ningún tercero.
